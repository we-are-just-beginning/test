...
# ================自定义槽函数============================
    ...
    def on_btnHandle_clicked(self):  # 为界面上的btnHandle按钮设置
        ...
        for region in reversed(regions):
            worksheet2 = worksheet1.copy(after=worksheet3, name=region)
            worksheet2["G2"].value = df2[df2['城市'] == region]['分公司'].values[0]
            worksheet2["G4"].value = df2[df2['城市']==region][0,15]
            worksheet2["G5"].value = df2[df2['城市']==region][0,16]
            worksheet2["D7"].value = df2[df2['城市']==region][0,18]            
            worksheet2["D9"].value = df2[df2['城市']==region][0,13]
            worksheet2["D11"].value = df2[df2['城市']==region][0,10]
            worksheet2["D12"].value = df2[df2['城市']==region][0,9]
            worksheet2["D13"].value = df2[df2['城市']==region][0,20]
            worksheet2["D15"].value = df2[df2['城市']==region][0,14]
            worksheet2["A19"].value = region
            worksheet2["C19"].value = df2[df2['城市']==region][0,10]
            worksheet2["D19"].value = df2[df2['城市']==region][0,9]
